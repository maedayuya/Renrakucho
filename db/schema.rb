...
ActiveRecord::Schema.define(version: 2020_03_08_074951) do
  ...
  create_table "admins", force: :cascade do |t|
    ...
    t.index ["category_id"], name: "index_admins_on_category_id"
  ...
  create_table "child_posts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["admin_id"], name: "index_child_posts_on_admin_id"
